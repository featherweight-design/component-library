  ...
  return (
    <div
      className={classnames({
        'uic-progress-bar': true,
        [className as string]: className,
      })}
    >
      <div className="uic-progress-bar__progress-container">
        <div
          className={classnames({
            'uic-progress-bar__fill-container': true,
            'uic-progress-bar__fill-container-rounded': isRounded,
          })}
          style={{
        ...
        >
          <div
            className={classnames({
              'uic-progress-bar__fill': true,
              'uic-progress-bar__fill-rounded': isRounded,
            })}
            style={{
              height: SIZES_ENUM[size],
        ...
        {shouldShowCompleteIcon && (
          <Icon
            className={classnames({
              'uic-progress-bar__completion-icon': true,
              'uic-progress-bar__completion-icon-hidden': !areAllItemsComplete,
            })}
            icon="success"
            color={color}
            size="1rem"
      ...
      {(shouldShowCountComplete || shouldShowPercentageComplete) && (
        <div className="uic-progress-bar__description-container">
          {shouldShowPercentageComplete && (
            <p className="uic-progress-bar__description-left">
              {percentageCompleteMessage}
            </p>
          )}
          {shouldShowCountComplete && (
            <p className="uic-progress-bar__description-right">
